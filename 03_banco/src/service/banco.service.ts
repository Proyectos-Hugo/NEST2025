...
export class BancoService {
  ...
  // buscar(numeroCuenta?:string, titular?:string, saldo?:string):Cuenta[]{
  //   return this.cuenta = this.cuenta.filter((cuenta: Cuenta) => cuenta.numeroCuenta === numeroCuenta
  //     || cuenta.titular === titular || cuenta.saldo === saldo);
  // }
  ...
  buscarTitular(tit :string):Cuenta[]{
    return this.cuenta.filter((cuenta:Cuenta) => cuenta.titular === tit);
  }
